...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-4](https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-4)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-4-gitops](https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-4-gitops)

# **Usage**

To access the remote-cluster-sep29-4 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of remote-cluster-sep29-4. You can access this namespace through the web console or via your CLI.
